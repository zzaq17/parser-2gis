...
## [Невошедшее]
### Изменено
- Проект мигрирован на Pydantic 2; минимальная версия Python повышена до 3.9.

### Исправлено
- Изменяемые значения моделей больше не используются как общие значения по умолчанию.
